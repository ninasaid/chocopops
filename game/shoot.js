...
function bullet_collision()
{
    ...
    for (var i = 0; i < player1.bullets.length; i++)
    {
        ...
        else 
        {
            ...
            if (Math.abs(player2.position.x - player1.bullets[i].position.x) < 10 && Math.abs(player2.position.y - player1.bullets[i].position.y) < 10)
            {
...
function player_collision()
{
    ...
    if (Math.abs(player2.position.x - player1.position.x) < 10 && Math.abs(player2.position.y - player1.position.y) < 10)
    {
        player1.life -= 1;
    }
